...
He decides to try a simple implementation of TF-IDF, a measure of the information content a term holds for a particular document in a 
document collection. However, he just started learning to code and somehow his numbers do not match what is expected. 
...
def idf(term, documents)
  ...
  # Math.log(number_of_documents / number_of_documents_with_term) --- bug
  Math.log(number_of_documents.fdiv(number_of_documents_with_term)) # Fix
end
